...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/bardium/random/main/plsdonateold'))()")
...
local sValues = {true, 30, true, 30, "#32CD32", 5, false, "", "Disabled", {"Thank you", "Thanks!", "ty :)", "tysm!"}, false, "WEEKLY GOAL: $C / $G", false, "your text here", "#ffffff", true, false, {"Please donate", "I'm so close to my goal!", "donate to me", "please"}, 10, 60, false, 3, false}
...
local oneRobuxOneJump = Window:AddTab("OneRobuxOneJump")
...
Players.LocalPlayer.leaderstats.Raised.Changed:Connect(function()
	...
	--serverWebhook("Someone using one of the free PLS Donate scripts earned: "..tostring(Players.LocalPlayer.leaderstats.Raised.value - RaisedC).." robux!")
